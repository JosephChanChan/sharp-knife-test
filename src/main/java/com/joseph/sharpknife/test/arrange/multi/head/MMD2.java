...
@Slf4j
@Component("mMD2")
@TaskConfig(taskName = "mMD2", taskType = "multiHeadMultiDepthType")
public class MMD2 implements TaskNode<SimpleContext, Integer> {
    @Override
    ...
    public BiConsumer<SimpleContext, Integer> getTask() {
        return (simpleContext, integerExecutionResult) -> {
            ...
            log.info("mMD2 sleeping! millis={}", millis);
