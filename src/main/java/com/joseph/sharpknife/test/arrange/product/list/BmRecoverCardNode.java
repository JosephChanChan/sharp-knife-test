...
@Slf4j
@Component
@TaskConfig(taskName = "bmRecoverCardNode", taskType = "productListType", timeout = 100)
public class BmRecoverCardNode implements TaskNode<ProductListContext, ProductListResult> {
