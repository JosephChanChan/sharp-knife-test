...
@Slf4j
@Component
@TaskConfig(taskName = "productIdBySearchNode", taskType = "productListType", timeout = 200)
public class ProductIdBySearchNode implements TaskNode<ProductListContext, ProductListResult> {
