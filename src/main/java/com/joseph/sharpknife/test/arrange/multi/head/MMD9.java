...
@Component("mMD9")
@DependsOn("mMD7")
@TaskConfig(taskName = "mMD9", taskType = "multiHeadMultiDepthType")
public class MMD9 implements TaskNode<SimpleContext, Integer> {
    @Override
    ...
    public BiConsumer<SimpleContext, Integer> getTask() {
        return (simpleContext, integerExecutionResult) -> {
            ...
            log.info("mMD9 sleeping! millis={}", millis);
