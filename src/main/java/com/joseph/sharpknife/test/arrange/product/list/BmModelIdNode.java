...
@Slf4j
@Component
@TaskConfig(taskName = "bmModelIdNode", taskType = "productListType", timeout = 100)
public class BmModelIdNode implements TaskNode<ProductListContext, ProductListResult> {
