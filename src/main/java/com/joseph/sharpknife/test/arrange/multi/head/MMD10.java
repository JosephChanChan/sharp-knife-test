...
@Component("mMD10")
@DependsOn("mMD8")
@TaskConfig(taskName = "mMD10", taskType = "multiHeadMultiDepthType")
public class MMD10 implements TaskNode<SimpleContext, Integer> {
    @Override
    ...
    public BiConsumer<SimpleContext, Integer> getTask() {
        return (simpleContext, integerExecutionResult) -> {
            ...
            log.info("mMD10 sleeping! millis={}", millis);
