...
@Slf4j
@Component
@TaskConfig(taskName = "productListAfterAbNode", taskType = "productListType", timeout = 100)
public class ProductListAfterAbNode implements TaskNode<ProductListContext, ProductListResult> {
