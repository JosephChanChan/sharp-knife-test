...
@Slf4j
@Component("mMD4")
@DependsOn({"mMD1", "mMD2", "mMD3"})
@TaskConfig(taskName = "mMD4", taskType = "multiHeadMultiDepthType")
public class MMD4 implements TaskNode<SimpleContext, Integer> {
    @Override
    ...
    public BiConsumer<SimpleContext, Integer> getTask() {
        return (simpleContext, integerExecutionResult) -> {
            ...
            log.info("mMD4 sleeping! millis={}", millis);
